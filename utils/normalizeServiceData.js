function normalizeServiceData(apiResult = {}, plan = {}) {
    return {
      ...
      tak_links: apiResult.tak_links || [],
      created_at: apiResult.created_at ? new Date(apiResult.created_at * 1000) : new Date(),
      expire_date: apiResult.expire_date || (apiResult.expiryTime ? new Date(apiResult.expiryTime * 1000).toISOString().split("T")[0] : ""),
